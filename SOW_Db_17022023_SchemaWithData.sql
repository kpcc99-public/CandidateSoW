USE [master]
GO
/****** Object:  Database [SOW_Db]    Script Date: 17-02-2023 14:25:37 ******/
...
USE [SOW_Db]
GO
/****** Object:  Table [dbo].[Account]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Candidate]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Country]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DellManager]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Domain]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Location]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Login]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Permission]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Recruiter]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Region]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RoleScreens]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Screens]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SOW]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SOWCandidate]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Status]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Technology]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USTPOC]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USTTPM]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Account_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[DashboardStats]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--select @StartDate;
--select @EndDate; 
SELECT DISTINCT 'Status' as Category,st.StatusName AS [Name] ,count(*) AS [Count]     
FROM [dbo].[SOW] so     
inner JOIN [dbo].[Status] st ON so.StatusId =st.StatusId AND so.isDeleted=0 
                                AND (so.RequestCreationDate >= @StartDate AND so.RequestCreationDate <= @EndDate)
                                group by st.StatusName ,so.StatusId     
UNION ALL    
SELECT DISTINCT 'Technology' as Category,T.TechnologyName AS [Name],count(*) AS [Count]     
FROM [dbo].[SOW] so     
Inner JOIN [dbo].[Technology] T ON T.TechnologyId =so.TechnologyId AND so.isDeleted=0 
                                   AND (so.RequestCreationDate >= @StartDate AND so.RequestCreationDate <= @EndDate)
                                   group by T.TechnologyName ,so.TechnologyId     
UNION ALL    
SELECT DISTINCT 'Region' as Category,R.Region AS [Name],count(*) AS [Count]     
FROM [dbo].[SOW] so     
Inner JOIN [dbo].[Region] R ON R.RegionId =so.RegionId AND so.isDeleted=0 
                             AND (so.RequestCreationDate >= @StartDate AND so.RequestCreationDate <= @EndDate)
                             group by R.Region ,so.RegionId    
End
GO
/****** Object:  StoredProcedure [dbo].[DellManager_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Domain_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Location_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[loginproc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Recruiter_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Region_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Sow_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END          
 ...
 END
GO
/****** Object:  StoredProcedure [dbo].[SowCandidate_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Status_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Technology_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[usp_addCandidateData]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_deleteCandidateData]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_editCandidateData]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_getAllCandidateData]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_showCandidateData]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[USTPOC_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[USTTPM_proc]    Script Date: 17-02-2023 14:25:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
